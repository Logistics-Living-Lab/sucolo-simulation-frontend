export const merano_profiles = {
  RETIREE: {
    name: 'Profile 1',
    description: 'Retiree-friendly location',
    freeTerm: -0.2,
    districtFeatures: [
      { name: "slope class", weight: -6 }
  ...
  FAMILY: {
    ...
    nearestAmenities: [
      ...
      { name: "cargo_bike_rental", distance: 400, weight: 7, penalty: 500 },
  ...
  MICRO_HUB: {
    ...
    nearestAmenities: [
      ...
      { name: "local_business", distance: 201, weight: 8, penalty: 500  }
    ],
    presentAmenities: [
      { name: "station_wheelchair", distance: 201, weight: 6 },
  ...
  MOBILITY_HUB: {
    ...
    nearestAmenities: [
      ...
      { name: "bicycle_rental", distance: 500, weight: 8, penalty: 500 },
      { name: "rental_service", distance: 600, weight: 6, penalty: 400 }
    ],
    countAmenities: [
      { name: "entertainment", distance: 400, weight: 4 },
