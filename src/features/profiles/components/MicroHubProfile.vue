<template>
  <div class="profile-component">
    <p>Optimized for <span class="bold-text">micro-hubs</span></p>
    <button
      @click="applyProfile"
      class="btn"
      :class="applied ? 'btn-success' : 'btn-primary'"
    >
      {{ applied ? 'Profile applied' : 'Apply Profile 4' }}
    </button>
  </div>
</template>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const applyProfile = () => {
      ...
      emit('profile-applied', profiles.MICRO_HUB);
